...
class child_box_visk(tk.Toplevel):
    ...
    def init_GUI(self):
        self.title("Диаграмма Бокса-Вискера")
        self.geometry('340x160')
        self.resizable(False, False)

        # Фрейм окна
        summary_table_group = tk.LabelFrame(self, text='Диаграмма Бокса-Вискера')
        ...
        btn_start = ttk.Button(summary_table_group, text='Начать анализ', command=self.box_visk_analyze)
