...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        def analyze1():
            messagebox.showinfo('Предупреждение', 'Невозможно произвести анализ с данными параметрами')
        ...
        def get_analysis():    
            ...
            if (choosen_analysis == "Базовая статистика"):
                ...
                dialog1.additional_information = ttk.Checkbutton(dialog1, text='Дополнительная информация')  
                ...
                dialog1.btn_ok = ttk.Button(dialog1, text='Начать анализ', command=analyze1)
                dialog1.btn_ok.place(x=50, y=250)
                btn_cancel = ttk.Button(dialog1, text='Закрыть', command=dialog1.destroy)
                ...
                label_quality1 = tk.Label(dialog2, text='Качественный столбец 1')
                label_quality1.place(x=50, y=50)
                label_quality2 = tk.Label(dialog2, text='Качественный столбец 2')
                label_quality2.place(x=50, y=80)
                label_numerical = tk.Label(dialog2, text='Численный столбец')
                label_numerical.place(x=50, y=110)
                dialog2.entry_quality1 = ttk.Combobox(dialog2, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog2.entry_quality1.current(0)
                dialog2.entry_quality1.place(x=200, y=50)
                dialog2.entry_quality2 = ttk.Combobox(dialog2, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog2.entry_quality2.current(0)
                dialog2.entry_quality2.place(x=200, y=80)
                
                dialog2.entry_numerical = ttk.Combobox(dialog2, values=[u'', u''])
                dialog2.entry_numerical.current(0)
                dialog2.entry_numerical.place(x=200, y=110)
                
                btn_cancel = ttk.Button(dialog2, text='Закрыть', command=dialog2.destroy)
                btn_cancel.place(x=300, y=170)
                
                dialog2.btn_ok = ttk.Button(dialog2, text='Начать анализ', command=analyze2)
                ...
                dialog3.entry_quality1 = ttk.Combobox(dialog3, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog3.entry_quality1.current(0)
                dialog3.entry_quality1.place(x=200, y=50)
                dialog3.entry_quality2 = ttk.Combobox(dialog3, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog3.entry_quality2.current(0)
                dialog3.entry_quality2.place(x=200, y=100)
                
                btn_cancel = ttk.Button(dialog3, text='Закрыть', command=dialog3.destroy)
                btn_cancel.place(x=300, y=170)
                
                dialog3.btn_ok = ttk.Button(dialog3, text='Начать анализ', command=analyze3)
                ...
                dialog4.entry_quality1 = ttk.Combobox(dialog4, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog4.entry_quality1.current(0)
                dialog4.entry_quality1.place(x=200, y=50)
                dialog4.entry_numerical = ttk.Combobox(dialog4, values=[u'', u''])
                dialog4.entry_numerical.current(0)
                dialog4.entry_numerical.place(x=200, y=100)
                
                btn_cancel = ttk.Button(dialog4, text='Закрыть', command=dialog4.destroy)
                btn_cancel.place(x=300, y=170)
                
                dialog4.btn_ok = ttk.Button(dialog4, text='Начать анализ', command=analyze4)
                ...
                label_numerical.place(x=50, y=100)
                dialog5.entry_quality1 = ttk.Combobox(dialog5, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog5.entry_quality1.current(0)
                dialog5.entry_quality1.place(x=200, y=50)
                dialog5.entry_numerical = ttk.Combobox(dialog5, values=[u'', u''])
                dialog5.entry_numerical.current(0)
                dialog5.entry_numerical.place(x=200, y=100)
                
                btn_cancel = ttk.Button(dialog5, text='Закрыть', command=dialog5.destroy)
                btn_cancel.place(x=300, y=170)
                
                dialog5.btn_ok = ttk.Button(dialog5, text='Начать анализ', command=analyze5)
                ...
                dialog6.entry_quality1 = ttk.Combobox(dialog6, values=[u'Название', u'Город', u'Регион', u'Контакты', u'Дополнительная информация'])
                dialog6.entry_quality1.current(0)
                dialog6.entry_quality1.place(x=200, y=50)           
                dialog6.entry_numerical1 = ttk.Combobox(dialog6, values=[u'', u''])
                dialog6.entry_numerical1.current(0)
                dialog6.entry_numerical1.place(x=200, y=80)
                dialog6.entry_numerical2 = ttk.Combobox(dialog6, values=[u'', u''])
                dialog6.entry_numerical2.current(0)
                dialog6.entry_numerical2.place(x=200, y=110)
                
                btn_cancel = ttk.Button(dialog6, text='Закрыть', command=dialog6.destroy)
                btn_cancel.place(x=300, y=170)
                
                dialog6.btn_ok = ttk.Button(dialog6, text='Начать анализ', command=analyze6)
        ...
        btn_open_dialog = tk.Button(editing_group, text='Добавить строку', command=self.open_dialog)
