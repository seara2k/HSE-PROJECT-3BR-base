...
class child_summary_table(tk.Toplevel):
    ...
    def init_GUI(self):
        ...
        # Фрейм окна
        summary_table_group = tk.LabelFrame(self, text='Параметры сводной таблицы')
        ...
        btn_start = ttk.Button(summary_table_group, text='Начать анализ', command=self.summary_table_analyze)
